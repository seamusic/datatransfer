namespace Sofire.Dynamic
{
    ...
    public class DynamicPropertyHelper<I> : DynamicHelperBase<I>
    {
        ...
        /// <summary>
        /// 初始化 <see cref="Sofire.Dynamic.DynamicPropertyHelper&lt;I&gt;"/> 类的新实例。
        /// </summary>
        ...
        /// <summary>
        /// 指定绑定动态实现的实例，初始化 <see cref="Sofire.Dynamic.DynamicPropertyHelper&lt;I&gt;"/> 类的新实例。
        /// </summary>
        /// <param name="instance">绑定的实例。可以为 null，表示动态实现 <typeparamref name="I"/> 的静态成员（或不设实例）。不为 null 的实例也可以用于以下情况：实现在父类中动态调用派生类的成员。</param>
        public DynamicPropertyHelper(I instance)
            : base(instance)
        {
        }

        /// <summary>
        /// 指定绑定动态实现的实例类型，初始化 <see cref="Sofire.Dynamic.DynamicPropertyHelper&lt;I&gt;"/> 类的新实例。
        /// </summary>
        /// <param name="instanceType">实例类型。</param>
        public DynamicPropertyHelper(Type instanceType)
            : base(instanceType)
        {
        }
        ...
        /// <summary>
        /// 指定属性名名和绑定标识，设置或获取一个值，动态实现实例的属性值。
        /// </summary>
        /// <param name="propertyName">属性名。</param>
        ...
        public object this[PropertyInfo propertyInfo]
        {
            ...
            set
            {
                this.CreateSetterHandler(propertyInfo)(ref this._Instance, value);
            }
        }
        ...
        public DynamicGetMemberHandler CreateGetterHandler(string propertyName)
        {
        ...
        /// <param name="bindingAttr">属性绑定标识。</param>
        /// <returns>返回一个动态属性获取器的工厂委托。</returns>
        public DynamicGetMemberHandler CreateGetterHandler(string propertyName, BindingFlags bindingAttr)
        {
        ...
        public DynamicGetMemberHandler CreateGetterHandler(PropertyInfo propertyInfo)
        {
            if(propertyInfo == null) return null;
            else if(propertyInfo.CanRead) return DynamicGetPropertyFactory.Instance.Create(propertyInfo);
        ...
        public DynamicSetMemberHandler CreateSetterHandler(string propertyName)
        {
        ...
        /// <param name="bindingAttr">属性绑定标识。</param>
        /// <returns>返回一个动态属性设置器的工厂委托。</returns>
        public DynamicSetMemberHandler CreateSetterHandler(string propertyName, BindingFlags bindingAttr)
        {
        ...
        /// <param name="propertyInfo">属性元数据。</param>
        /// <returns>返回一个动态属性设置器的工厂委托。</returns>
        public DynamicSetMemberHandler CreateSetterHandler(PropertyInfo propertyInfo)
        {
            if(propertyInfo == null) return null;
            else if(propertyInfo.CanWrite) return DynamicSetPropertyFactory.Instance.Create(propertyInfo);
        ...
        {
            return this.GetProperty(propertyName, MemberFlags.InstanceFlags);
        }
