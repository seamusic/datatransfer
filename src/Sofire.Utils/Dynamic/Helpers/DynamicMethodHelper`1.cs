...
namespace Sofire.Dynamic
{
    ...
    public delegate object DynamicMethodInvoke(params object[] parameters);

    /// <summary>
    /// 表示方法的动态实现。
    /// </summary>
    /// <typeparam methodName="I">实例的类型。</typeparam>
    public class DynamicMethodHelper<I> : DynamicHelperBase<I>
    {
        /// <summary>
        /// 初始化 <see cref="Sofire.Dynamic.DynamicMethodHelper&lt;I&gt;"/> 类的新实例。
        /// </summary>
        public DynamicMethodHelper() { }

        /// <summary>
        /// 指定绑定动态实现的实例，初始化 <see cref="Sofire.Dynamic.DynamicMethodHelper&lt;I&gt;"/> 类的新实例。
        /// </summary>
        ...
        /// <summary>
        /// 指定绑定动态实现的实例类型，初始化 <see cref="Sofire.Dynamic.DynamicMethodHelper&lt;I&gt;"/> 类的新实例。
        /// </summary>
        ...
        public DynamicMethodInvoke this[string methodName, params Type[] types]
        {
            get
            {
        ...
        /// <param name="types">方法参数的类型集合。</param>
        /// <returns>返回一个动态绑定的方法委托。</returns>
        public DynamicMethodInvoke this[string methodName, BindingFlags bindingAttr, params Type[] types]
        {
            get
            {
        ...
        /// <returns>返回一个动态绑定的方法委托。</returns>
        public DynamicMethodInvoke this[MethodInfo methodInfo]
        {
            get
            {
        ...
        public DynamicMethodHandler CreateHandler(string methodName)
        {
        ...
        /// <param name="bindingAttr">方法绑定标识。</param>
        /// <returns>返回一个动态创建实例的工厂委托。</returns>
        public DynamicMethodHandler CreateHandler(string methodName, BindingFlags bindingAttr)
        {
        ...
        /// <param name="types">方法参数的类型集合。</param>
        /// <returns>返回一个动态创建实例的工厂委托。</returns>
        public DynamicMethodHandler CreateHandler(string methodName, params Type[] types)
        {
        ...
        /// <param name="types">方法参数的类型集合。</param>
        /// <returns>返回一个动态创建实例的工厂委托。</returns>
        public DynamicMethodHandler CreateHandler(string methodName, BindingFlags bindingAttr, params Type[] types)
        {
        ...
        /// <param name="methodInfo">方法元数据。</param>
        /// <returns>返回一个动态创建实例的工厂委托。</returns>
        public DynamicMethodHandler CreateHandler(MethodInfo methodInfo)
        {
            return DynamicMethodFactory.Instance.Create(methodInfo);
        }
        ...
        {
            return this.GetMethodInfo(methodName, MemberFlags.InstanceFlags, types);
        }
