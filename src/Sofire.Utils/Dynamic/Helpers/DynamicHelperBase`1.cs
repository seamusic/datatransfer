namespace Sofire.Dynamic
{
    ...
    public abstract class DynamicHelperBase<I>
    {
        ...
        /// <summary>
        /// 初始化 <see cref="Sofire.Dynamic.DynamicHelperBase&lt;I&gt;"/> 类的新实例。
        /// </summary>
        ...
        /// <summary>
        /// 指定绑定动态实现的实例，初始化 <see cref="Sofire.Dynamic.DynamicHelperBase&lt;I&gt; "/> 类的新实例。
        /// </summary>
        ...
        /// <summary>
        /// 指定绑定动态实现的实例类型，初始化 <see cref="Sofire.Dynamic.DynamicHelperBase&lt;I&gt; "/> 类的新实例。
        /// </summary>
