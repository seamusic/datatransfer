namespace Sofire.Dynamic
{
    ...
    public class DynamicFieldHelper<I> : DynamicHelperBase<I>
    {
        ...
        /// <summary>
        /// 初始化 <see cref="Sofire.Dynamic.DynamicFieldHelper&lt;I&gt;"/> 类的新实例。
        /// </summary>
        public DynamicFieldHelper() { }

        /// <summary>
        /// 指定绑定动态实现的实例，初始化 <see cref="Sofire.Dynamic.DynamicFieldHelper&lt;I&gt;"/> 类的新实例。
        /// </summary>
        /// <param name="instance">绑定的实例。可以为 null，表示动态实现 <typeparamref name="I"/> 的静态成员（或不设实例）。不为 null 的实例也可以用于以下情况：实现在父类中动态调用派生类的成员。</param>
        public DynamicFieldHelper(I instance)
            : base(instance)
        {
        }

        /// <summary>
        /// 指定绑定动态实现的实例类型，初始化 <see cref="Sofire.Dynamic.DynamicFieldHelper&lt;I&gt;"/> 类的新实例。
        /// </summary>
        /// <param name="instanceType">实例类型。</param>
        public DynamicFieldHelper(Type instanceType)
            : base(instanceType)
        {
        }
        ...
        /// <summary>
        /// 指定字段名和绑定标识，设置或获取一个值，动态实现实例的字段值。
        /// </summary>
        /// <param name="fieldName">字段名。</param>
        ...
        public object this[FieldInfo fieldInfo]
        {
            ...
            set
            {
                this.CreateSetterHandler(fieldInfo)(ref this._Instance, value);
            }
        }
        ...
        public DynamicGetMemberHandler CreateGetterHandler(string fieldName)
        {
        ...
        /// <param name="bindingAttr">字段绑定标识。</param>
        /// <returns>返回一个动态字段获取器的工厂委托。</returns>
        public DynamicGetMemberHandler CreateGetterHandler(string fieldName, BindingFlags bindingAttr)
        {
        ...
        /// <param name="fieldInfo">字段元数据。</param>
        /// <returns>返回一个动态字段获取器的工厂委托。</returns>
        public DynamicGetMemberHandler CreateGetterHandler(FieldInfo fieldInfo)
        {

            return DynamicGetFieldFactory.Instance.Create(fieldInfo);
        }
        ...
        public DynamicSetMemberHandler CreateSetterHandler(string fieldName)
        {
        ...
        /// <param name="bindingAttr">字段绑定标识。</param>
        /// <returns>返回一个动态字段设置器的工厂委托。</returns>
        public DynamicSetMemberHandler CreateSetterHandler(string fieldName, BindingFlags bindingAttr)
        {
        ...
        /// <param name="fieldInfo">字段元数据。</param>
        /// <returns>返回一个动态字段设置器的工厂委托。</returns>
        public DynamicSetMemberHandler CreateSetterHandler(FieldInfo fieldInfo)
        {
            return DynamicSetFieldFactory.Instance.Create(fieldInfo);
        }
        ...
        {
            return this.GetFields(fieldName, MemberFlags.InstanceFlags);
        }
