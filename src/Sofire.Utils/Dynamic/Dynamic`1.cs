...
namespace Sofire.Dynamic
{
    ...
    public class Dynamic<I>
    {
        ...
        /// <summary>
        /// 初始化 Sofire.Dynamic.Dynamic&lt;I&gt; 类的新实例。
        /// </summary>
        public Dynamic()
            : this(typeof(I)) { }
        ...
        {
            if(instanceType == null) throw new ArgumentNullException("instanceType");
            return Create(instanceType.GetConstructor(Sofire.Dynamic.MemberFlags.AnyFlags, null, types ?? System.Type.EmptyTypes, null), parameters);
        }
        ...
        public static Factories.DynamicConstructorHandler CreateHandler(ConstructorInfo constructorInfo)
        {
            return Sofire.Dynamic.Factories.DynamicConstructorFactory.Instance.Create(constructorInfo);
        }
    }
}